                ...
                <div className="flex items-center justify-between bg-linear-to-r from-[#0F3D33] to-[#1F6F57] rounded-2xl overflow-hidden ">
                    ...
                    <div className="text-white max-w-150 pl-18">
                        ...
                        <h2 className="text-3xl font-semibold leading-snug mb-5">
                            Whether you are ready to build or starting out ADU Atlas walks
                            you thought the process.
                        </h2>

                        <p className="text-sm text-gray-200 mb-8">
                            Any builder contractor needs the following information from you
                            to provide you with an accurate scope of work and realistic
                            estimates.
                        </p>
