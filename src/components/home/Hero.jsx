  ...
  return (
    <AdminEditableSection keys={EDIT_KEYS} label="Hero">
      <section className="bg-surface-1-solid relative overflow-hidden">
        <Contours />
        <div className="container mx-auto px-5 sm:px-8 pt-10 pb-14 lg:pt-16 lg:pb-20 grid lg:grid-cols-12 gap-10 lg:gap-12 items-center relative">
          <div className="lg:col-span-5 animate-fade-up">
            ...
            <AddressIntake cta={cta} placeholder={typed || placeholder} className="max-w-lg" />
          ...
          <div className="lg:col-span-7 relative animate-fade-up" style={{ animationDelay: "120ms" }}>
            <div className="relative rounded-[1.75rem] overflow-hidden aspect-[3/2] lg:aspect-[4/3] shadow-[0_30px_60px_-30px_rgba(23,32,27,0.35)]">
