...
import { FiBarChart2, FiUsers, FiShield, FiFileText, FiClipboard, FiMenu, FiX, FiLogOut } from "react-icons/fi";
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="px-5 py-7 border-b border-stroke">
        ...
        <p className="text-paper-dim text-[0.65rem] uppercase tracking-[0.2em]">Admin console</p>
      </div>
